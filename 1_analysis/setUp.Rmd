...
3. Reads quantification peforemd with `featureCounts`
...
#save plot
ggsave("counts_after_filtering_2_3.svg",
       plot = afterFiltering,
       path = here::here("2_plots/qc/"))
...
cowplot::plot_grid(beforeFiltering, afterFiltering)
ggsave(filename = "counts_before_after_filtering_2_3.svg",
        path = here::here("2_plots/qc/"),
